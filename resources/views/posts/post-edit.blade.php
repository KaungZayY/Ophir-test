            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form action="{{route('post.update',$post->id)}}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="title" id="title" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500" value="{{$post->title}}" required>
                        @error('title')
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="body" id="body" rows="4" class="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500" required>{{$post->body}}</textarea>
                        @error('body')
                            <p class="text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
